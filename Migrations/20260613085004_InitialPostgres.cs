        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_inregistrarii = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    titlu = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    descriere = table.Column<string>(type: "text", nullable: false),
                    PretPornire = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PretCurent = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    data_finalizare = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsPaymentConfirmed = table.Column<bool>(type: "boolean", nullable: false),
                    seller_id = table.Column<string>(type: "text", nullable: false),
                    ImaginePath = table.Column<string>(type: "text", nullable: true),
                    Categorie = table.Column<int>(type: "integer", nullable: false),
                    CastigatorId = table.Column<string>(type: "text", nullable: true),
                    EsteIncheiata = table.Column<bool>(type: "boolean", nullable: false),
                    NotificareTrimisa = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    suma = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
